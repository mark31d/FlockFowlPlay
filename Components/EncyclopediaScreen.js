...
// пример плейлиста
const PLAYLIST = [
  { id: 'trk1', title: 'Cossack Blackbird', img: require('../assets/CossackBlackbird.png'), src: require('../assets/blackbird_singing.mp3') },
  { id: 'trk2', title: 'Dove',            img: require('../assets/Dove.png'),             src: require('../assets/owl.mp3') },
...
const st = StyleSheet.create({
  ...
  plCard: { flexDirection: 'row', alignItems: 'flex-start', paddingVertical: 14, marginBottom: 8, paddingRight: 8 },
  plThumb: { width: 56, height: 56, borderRadius: 6, marginRight: 12 },
  trHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  ...
  observeBtn: { backgroundColor: YEL, borderRadius: 14, margin: 20, paddingVertical: 18, alignItems: 'center' },
